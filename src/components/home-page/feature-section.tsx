...
export default function FeatureSection() {
  ...
  return (
    <div className="min-h-screen bg-[#F6F6F6]  py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 items-start gap-16 lg:gap-0">
          {/* Left side - Main headline */}
          <div className="space-y-4 font-semibold text-2xl">
            <h1 className=" font-semibold leading-tight font-poppins">
              <span className="multi-line-gradient block  md:text-6xl text-5xl">
                Generative voice
                <br />
                AI platform
                <br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-2">
