...
function HeroSection() {
  return (
    <div id="hero-section" className='relative h-[130vh] overflow-hidden'>
      <Image src="/images/hero-bg.png" alt="Hero" fill className='object-cover' />
      
      {/* Dark overlay for better text readability */}
      <div className='absolute inset-0 bg-black/20 z-5'></div>
      
      <div className='relative z-10 flex flex-col justify-center items-center h-[110vh] px-4 text-center'>
        {/* Main Heading */}
        <h1 className='text-6xl md:text-7xl lg:text-8xl font-semibold primary-font text-white mb-8 '>
          We - Craft<br />
          Business
        </h1>
        ...
        <p className='text-lg md:text-xl text-white/90 max-w-2xl mb-12 leading-relaxed'>
          Transform your business into a digital brand to stand out<br />
          among your competitors.
        </p>
        
        {/* CTA Button */}
        <button className='group flex items-center gap-3 bg-transparent border-2 border-white/30 hover:border-white/50 text-white px-8 py-4 rounded-full transition-all duration-300 hover:bg-white/10 backdrop-blur-sm'>
