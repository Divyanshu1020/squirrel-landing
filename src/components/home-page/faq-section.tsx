  ...
  return (
    <div className=" bg-white  py-16">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-6xl font-bold multi-line-gradient primary-font mb-8">Questions & Answers</h2>
        </div>
                ...
                <AccordionItem value={faq.id} className="border-none">
                  <AccordionTrigger className="hover:no-underline py-6 text-left">
                    <div className="flex items-center gap-6 w-full">
                      <span className="text-2xl primary-font font-bold text-gray-900 min-w-[3rem]">{faq.id}</span>
                      <span className="text-lg md:text-xl secondary-font font-medium text-gray-900 flex-1">{faq.question}</span>
                    </div>
                    <div className="size-8 primary-gradient rounded-full flex items-center justify-center  ">
                      <span className="text-white text-lg font-bold">+</span>
                    </div>
                  </AccordionTrigger>
                  <AccordionContent className="pb-6">
                    <div className="ml-20 secondary-font text-gray-600 text-base leading-relaxed">{faq.answer}</div>
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
